(function () {
 ...
 /* Alter the Primo Browse page, Matthew Hull, December 2018 */ 
  ...
  app.controller('customCSCU_prmSearchResultListAfter', ['$timeout', function($timeout) {
      ...
      vm.cscu_unhide_me = function() {
        var my_element = document.getElementById("customCSCU-consortium-search-card");
        if (my_element) { my_element.classList.remove("hide"); } /* Make it visible, now. */
      };

  }]);
  /* MY CCSU SECTiON */
    app.component('ccsuBannerComponent',  {
        template: '<div id="banner-component">Check our <a href="https://libguides.ccsu.edu/2021">Guide to Library Services</a> for the latest on policies & services for CCSU students, faculty & guests</div>'
    })
...
// Adds the LibChat button - float button
(function() {
  var lcfloat = document.createElement('script');
  lcfloat.type = 'text/javascript';
  lcfloat.async = 'true';
  
  // lcfloat.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'v2.libanswers.com/load_chat.php?hash=26ad10df74cd6fb07e126e6793c5b995';
  lcfloat.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'v2.libanswers.com/load_chat.php?hash=26ad10df74cd6fb07e126e6793c5b995';

  var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(lcfloat, s);

})();
// PRIMO SPECIFIC LIBCHAT BUTTON ABOVE

/* Normal Javascript 
   ================================================================================ 
*/ 
/* Add a bit of Javascript to send a Pageview to our Google Analytics. */ 
(function (trackerID) {
  var GAreferrer;
  var GAappId = trackerID;  /* Your own Google-Analytics account Property Tracking-ID (UA-XXXXXXXX-X) */
  if (typeof galoc === 'undefined') {
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
  })(window,document,'script','https://www.google-analytics.com/analytics.js',"galoc");
  }
  galoc("create", GAappId, 'auto', "primoTracker");
  galoc("primoTracker.set", 'anonymizeIp', true);
  galoc(function(tracker) {
    GAreferrer = tracker.get('referrer');
  });
  if (!GAreferrer) GAreferrer = document.referrer || 'unknown';
  galoc("primoTracker.set", 'referrer', GAreferrer); 
  galoc("primoTracker.set", 'title', "Primo Discovery");
  galoc("primoTracker.send", 'pageview');
  console.log("Sent Google-Analytics page-view. Referrer = " + GAreferrer); // debug 
})("UA-4213386-9");
